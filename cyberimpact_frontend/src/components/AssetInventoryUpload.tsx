...
export default function AssetInventoryUpload({ onUploadSuccess }: AssetInventoryUploadProps) {
    ...
    const downloadDocument = async (docId: string, filename: string) => {
        try {
            ...
            link.href = url;
            link.download = `${filename.replace('.xlsx', '')}_data.json`;
        ...
        <div className="space-y-6">
            <div className="bg-gray-900/60 backdrop-blur-md shadow-xl rounded-xl border border-gray-800 p-6">
                ...
                bg-gray-800 rounded-lg border border-gray-700"
                    ...
                    >
                        {uploading ? 'Uploading...' : 'Upload Asset Inventory'}
                    </button>
            ...
            <div className="bg-gray-900/60 backdrop-blur-md shadow-xl rounded-xl border border-gray-800 p-6">
                <div className="flex justify-between items-center mb-4">
                    <h3 className="text-xl font-bold text-blue-300">Uploaded Asset Inventories</h3>
                    <button
                ...
                {documents.length === 0 ? (
                    ...
                    <div className="space-y-2">
                        {documents.map((doc) => (
                            <div
                                key={doc.id}
                                className="flex justify-between items-center p-4 bg-gray-800/50 rounded-lg border border-gray-700 hover:border-blue-500 transition"
                            >
                                <div className="flex-1">
                                    <p className="font-semibold text-gray-200">{doc.filename}</p>
